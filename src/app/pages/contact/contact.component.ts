...
export class ContactComponent {
  ...
  onSubmit() {
    if (
      ...
      this.contactService.sendContactForm(this.contactForm.controls.email.value, this.contactForm.controls.subject.value, this.contactForm.controls.message.value)
      .subscribe({
        next: (response) => {
